...
<body>
<?php buildHeaderNEW("leaveType", null, "leaveTypes", "Leave Types", "Add a Leave Type"); ?>
<div align="center">
...
<table class="data" align="center" cellspacing="0">
  <tr>
	...
	echo ">";
	?>
	<td><a href="leaveTypeUpdate.php?leaveType=<?php echo $row_rsLeaveTypes['leaveTypeID']; ?>"><?php echo $row_rsLeaveTypes['leaveType']; ?></a></td>
	<?php sudoAuthData("leaveType", "Update Leave Type", "td", "edit", "function=update&amp;leaveType=" . $row_rsLeaveTypes['leaveTypeID']); ?>
    </tr>
  <?php } while ($row_rsLeaveTypes = mysql_fetch_assoc($rsLeaveTypes)); ?>
</table>
<div id="count">Viewing <?php echo ($startRow_rsLeaveTypes + 1) ?> through <?php echo min($startRow_rsLeaveTypes + $maxRows_rsLeaveTypes, $totalRows_rsLeaveTypes) ?> of <?php echo $totalRows_rsLeaveTypes ?> Leave Types</div>
