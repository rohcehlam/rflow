	...
	<ul class="nav navbar-nav">
		...
		<li class="dropdown user user-menu">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown">
				<img src="<?php echo $avatar_image; ?>" class="user-image" alt="User Image"/>
				<span class="hidden-xs"><?php echo $row_rsEmployeeInfo['firstName']; ?></span>
			</a>
			<ul class="dropdown-menu">
				<!-- User image -->
				<li class="user-header">
					<img src="<?php echo $avatar_image; ?>" class="img-circle" alt="User Image" />
					<p>
						<?php
						if (!isset($_SESSION['employee'])) {
				...
				<li class="user-footer">
					<div class="pull-left">
						<a class="btn btn-default btn-flat" id="myPortal"  href="#">My Portal</a>
					</div>
					<div class="pull-right">
						<a class="btn btn-default btn-flat" id="sessionKiller"  href="#">Sign out</a>
					</div>
				</li>
			</ul>
		</li>
