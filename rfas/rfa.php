	 ...
	 <body class="skin-blue sidebar-mini">
		  ...
		  <div class="wrapper">
				...
				<div class="content-wrapper">
					 ...
					 <?php breadcrumbs([['url' => '../userPortals/myPortal.php', 'text' => 'DashBoard'], ['url' => 'rfas.php', 'text' => 'RFCs'], ['url' => '#', 'text' => ucwords($my_get['function']) . ' a RFC']], ucwords($my_get['function']) . ' a RFC') ?>

					 <section class="content">

						  <div class="box box-primary">
								<div class="box-header with-border">
									 <h3 class="box-title"><?php echo ucwords($my_get['function']); ?> a RFC</h3>
								</div>
								<div class="box-body">
