						...
						<form class="form-horizontal" action="rfaSend.php" method="post" enctype="multipart/form-data" name="rfaForm">
							...
							<div class="form-group">
								<?php if ($my_get['function'] == "add") { ?>
									...
									<div class="col-xs-2">
										<div class="input-group">
											...
											<input type="text" id="dateSubmitted" name='dateSubmitted' class="form-control" placeholder="<?php echo date('m/d/Y') ?>"/>
										</div>
									</div>
									<div class="col-xs-3">
										<div class="input-group">
								...
								<?php } else { ?>
									...
									<div class="col-xs-4"><p class="form-control-static"><?php echo $row_rsRFA['submittedBy']; ?></p></div>
									<label for='startdate' class="control-label col-xs-1">On:</label>
									<div class="col-xs-2"><p class="form-control-static"><?php echo $row_rsRFA['dateSubmitted']; ?></p></div>
									<div class="col-xs-3"><p class="form-control-static">at:&nbsp;<?php echo $row_rsRFA['timeSubmitted']; ?>&nbsp;UTC</p></div>
								<?php } ?>
							</div>
							<div class='form-group'>
									...
									<div class="input-group">
										...
										<?php if ($my_get['function'] != "add") { ?>
											<span class="input-group-addon">
												...
												?>"><?php echo ($my_get['modWindow'] == "y") ? "Cancel Update/Approve RFC" : "Update/Approve RFC"; ?></a>
											</span>
										<?php } ?>
									</div>
								</div>
							...
							<div class='form-group'>
								<label for='status' class="control-label col-xs-2">Layer:</label>
								<div class="col-xs-4">
									<?php if (($my_get['function'] == "add") || ($my_get['function'] == "update")) {
