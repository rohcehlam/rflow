    ...
    var methods = {
        init: function (opts) {
            ...
            block["period"] = $("<span class='cron-period'>"
                    + "<div class='col-xs-4'><div class='input-group'><span class='input-group-addon'>Every</span><select name='cron-period' class='form-control'>" + custom_periods
                    + str_opt_period + "</select></div></div></span>")
                    .appendTo(this)
                    .data("root", this);
            ...
            block["dom"] = $("<span class='cron-block cron-block-dom'>"
                    + "<div class='col-xs-2'><div class='input-group'><span class='input-group-addon'>on the</span><select name='cron-dom' class='form-control'>" + str_opt_dom
                    + "</select></div></div></span>")
                    .appendTo(this)
                    .data("root", this);
            ...
            block["month"] = $("<span class='cron-block cron-block-month'>"
                    + "<div class='col-xs-2'><div class='input-group'><span class='input-group-addon'>of</span><select name='cron-month' class='form-control'>" + str_opt_month
                    + "</select></div></div></span>")
                    .appendTo(this)
                    .data("root", this);
            ...
            block["mins"] = $("<span class='cron-block cron-block-mins'>"
                    + "<div class='col-xs-4'><div class='input-group'><span class='input-group-addon'>at</span><select name='cron-mins' class='form-control'>" + str_opt_mih
                    + "</select><span class='input-group-addon'>minutes past the hour</span></div></div></span>")
                    .appendTo(this)
                    .data("root", this);
            ...
            block["dow"] = $("<span class='cron-block cron-block-dow'>"
                    + "<div class='col-xs-2'><div class='input-group'><span class='input-group-addon'>on</span><select name='cron-dow' class='form-control'>" + str_opt_dow
                    + "</select></div></div> </span>")
                    .appendTo(this)
                    .data("root", this);
            ...
            block["time"] = $("<span class='cron-block cron-block-time'>"
                    + "<div class='col-xs-2'><div class='input-group'><span class='input-group-addon'>at</span><select name='cron-time-hour' class='cron-time-hour form-control'>" + str_opt_hid
                    + "</select></div></div>"
                    + "<div class='col-xs-2'><div class='input-group'><span class='input-group-addon'>:</span><select name='cron-time-min' class='cron-time-min form-control'>" + str_opt_mih
                    + "</select></div></div></span>")
                    .appendTo(this)
                    .data("root", this);
