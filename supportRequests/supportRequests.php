...
function priority_icon($priority) {
	switch ($priority) {
		...
		case 'Hot':
			?>
			<span class='label bg-gray'><label class='glyphicon glyphicon-chevron-up text-red'></label></span>
			<?php
			break;
		case 'Medium':
			?>
			<span class='label bg-gray'><label class='glyphicon glyphicon-minus text-yellow'></label></span>
			<?php
			break;
		case 'Low':
			?>
			<span class='label bg-gray'><label class='glyphicon glyphicon-chevron-down text-blue'></label></span>
			<?php
			break;
	}
}
